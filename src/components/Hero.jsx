...
import { parallaxforeground } from '../assets';
    ...
    return (
        <>
            <section id='header' className='bg-[#050c0F] mt-[105px]'>
                <div className=" h-[100vh] w-[100%] bg-hero-background  relative ">
                    <img src={parallaxforeground} alt="" className='hidden md:block h-[600px] w-[500px] z-30 absolute top-0 bottom-0 left-0 right-0 m-auto ' />
                ...
                <div>
                    ...
                    <div className=' mt-5 text-2xl font-bold text-[#ece6df]  px-10 font-heading mx-auto  md:text-5xl md:px-0 '>I write code for a living.</div>
